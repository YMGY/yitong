...
from icismeg.items import IcisMegItem


class icisMeg(Spider):
    name = 'icismeg'
    ...
    def login(self, response):
        formdata = {"UserName": "sunnychenyt@enmore.com", "Password": "20180207", "RememberMe": "true",
                    "LoginButton": "登录"}
